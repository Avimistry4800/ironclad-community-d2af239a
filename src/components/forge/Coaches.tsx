...
const COACHES = [
  {
    ...
    bio: "Former competitive powerlifter (945 raw total). Built FORGE in 2014 after 8 years coaching collegiate athletes. Specializes in long-arc strength periodization for intermediate-to-advanced lifters.",
  ...
  },
  {
    ...
    bio: "Ex-D1 rower. Designs FORGE's metabolic protocols and runs the SHRED program. Trained 400+ women through measurable composition change without crash dieting.",
  ...
  },
  {
    ...
    bio: "Background in physical therapy and movement integration. Leads FORGE's mobility curriculum and works 1-on-1 with athletes battling chronic restrictions.",
  ...
  },
  {
    ...
    bio: "IPF national-level competitor. Programs for FORGE's raw lifters and runs quarterly meet-prep blocks. No-nonsense execution with athletes targeting elite totals.",
  ...
  },
  {
    ...
    bio: "NPC bikini competitor turned coach. Specializes in evidence-based hypertrophy and contest prep. Owns FORGE's HYPERTROPHY block and macro coaching.",
    prs: ["NPC Top 5 · 2x"],
  },
];
